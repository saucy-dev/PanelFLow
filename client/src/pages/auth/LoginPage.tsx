...
import { Layers, Shield, Users, User, ArrowRight, CheckCircle2, Lock } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col justify-center items-center p-4 sm:p-6 select-none">
      <div className="w-full max-w-md bg-white rounded-3xl border border-slate-200 shadow-xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        {/* Top Logo Banner */}
        <div className="bg-gradient-to-br from-slate-900 via-slate-850 to-blue-950 text-white p-6 text-center space-y-2">
        ...
        {activeTab === 'admin' && (
          <form onSubmit={handleAdminLogin} className="p-6 space-y-4">
            ...
            >
              <Lock className="w-4 h-4 mr-1.5" /> Sign In as Admin Coordinator
            </Button>
          </form>
        )}
        ...
        {activeTab === 'panel' && (
          <div className="p-6 space-y-4">
            <div>
              ...
              <div className="grid grid-cols-2 gap-2.5">
                {['P1', 'P2', 'P3', 'P4'].map((code) => (
                  ...
                  >
                    <span className="font-mono text-base block font-black">Panel {code}</span>
            ...
            <p className="text-center text-[11px] text-slate-400">
              Clicking a panel will open its dedicated real-time interviewer workstation.
            </p>
          </div>
        )}
