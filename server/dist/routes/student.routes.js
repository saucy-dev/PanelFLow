...
router.get('/lookup/:registrationNumber', student_controller_js_1.StudentController.lookupByRegistration);
router.get('/:id', student_controller_js_1.StudentController.getStudentById);
